        ...
        <nav class="relative flex container py-6 px-0">
            ...
            <div class="nav-links hidden relative items-center justify-end flex-1 md:flex">
                <ul class="mr-9 space-x-4">
                    <router-link class="link font-medium text-2xl py-2 px-4 rounded-full hover:bg-teal transition-colors duration-300" to="#">主页</router-link>
                    <router-link class="link font-medium text-2xl py-2 px-4  rounded-full hover:bg-teal transition-colors duration-300" to="#">笔记</router-link>
                    <router-link class="link font-medium text-2xl py-2 px-4  rounded-full hover:bg-teal transition-colors duration-300" to="#">创建笔记</router-link>
                    <router-link class="link font-medium text-2xl py-2 px-4 rounded-full hover:bg-teal transition-colors duration-300" to="#">登录/注册</router-link>
                </ul>
            </div>
