<template lang="">
    <div class="form-wrap overflow-hidden flex flex-row h-screen justify-center self-center my-0 mx-auto w-11/12 lg:w-full ">
        <form class="login py-0 px-3 relative flex flex-col justify-center items-center flex-1 lg:px-12" action="">
            ...
            忘记密码找回</router-link>
            <button class="flex flex-row justify-center items-center text-1xl cursor-pointer mt-6 transition-all duration-500 w-32 py-2 px-3 bg-char text-white rounded-full border-none hover:scale-105 hover:font-bold hover:bg-white hover:text-char focus:outline-none" to="#">
